...
class PhotoSearchPagingSource @Inject constructor(private val tags: String, @Named("PhotoPagingDataUseCase") private val useCase: PhotoPagingDataUseCaseImpl) : RxPagingSource<Int, FlickrPhoto>() {
